...
class MediumDropletStatsConfigurationActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            if (appWidgetId == AppWidgetManager.INVALID_APPWIDGET_ID) {
                Log.e("MediumDropletConfig", "Invalid appWidgetId")
                finish()
                return
            }
            ...
            setContent {
                ...
                LaunchedEffect(Unit) {
                    ...
                    try {
                                    ...
                                    try {
                                        ...
                                        for (urn in dropletUrns) {
                                            ...
                                            try {
                                                ...
                                                Log.e("MediumDropletConfig", "Error fetching droplet $dropletId: ${e.message}", e)
                                            }
                                        }
                                    } catch (e: Exception) {
                                        Log.e("MediumDropletConfig", "Error fetching resources: ${e.message}", e)
                                    }
                                }
                            } catch (e: Exception) {
                                Log.e("MediumDropletConfig", "Error fetching projects: ${e.message}", e)
                            }
                        }
                        ...
                        Log.e("MediumDropletConfig", "Error: ${e.message}", e)
                        error = e.message
                        isLoading = false
                    }
                }
                                    ...
                                    try {
                                        ...
                                        if (connections.isNotEmpty()) {
                                            ...
                                            val stats = withContext(Dispatchers.IO) {
                                                fetchDropletStats(connection, project.id)
                                            }

                                            if (stats != null) {
                                                MediumDropletStatsWidgetReceiver().updateNowStats(
                                                    applicationContext,
                                                    glanceId,
                                                    stats.cpu,
                                                    stats.memory,
                                        ...
                                        Log.e("MediumDropletConfig", "Error fetching stats: ${e.message}", e)
                                    }
                                }
            ...
            Log.e("MediumDropletConfig", "Error in onCreate: ${e.message}", e)
            e.printStackTrace()
            finish()
        }
    }
